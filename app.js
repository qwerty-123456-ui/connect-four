document.addEventListener('DOMContentLoaded',() => {
    ...
    (function(index){
        //add an onclick for each square in grid
        squares[i].onclick=function(){
            //if the square below ur current square is taken, you can also go ontop of it
            ...
            // if the square below ur current square is not taken , yoy can't go there
            else{
                alert('U can\'t go there')
            }
